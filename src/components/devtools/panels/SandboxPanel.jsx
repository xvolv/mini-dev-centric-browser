    ...
    <div className="tool-panel">
      <div className="sandbox__editors">
        <div className="sandbox__editor-section">
          ...
          <textarea className="sandbox__textarea" value={html} onChange={(e) => setHtml(e.target.value)} spellCheck={false} />
        </div>
        <div className="sandbox__editor-section">
          <div className="sandbox__editor-header">
          ...
          <textarea className="sandbox__textarea" value={css} onChange={(e) => setCss(e.target.value)} spellCheck={false} />
        </div>
        <div className="sandbox__editor-section">
          <div className="sandbox__editor-header">
          ...
          <textarea className="sandbox__textarea" value={js} onChange={(e) => setJs(e.target.value)} spellCheck={false} />
        </div>
      </div>
      <div className="sandbox__preview-container">
        <div className="sandbox__preview-header">▶ Preview</div>
        <iframe ref={iframeRef} className="sandbox__preview-iframe" title="Sandbox Preview" sandbox="allow-scripts" />
      </div>
    </div>
  );
}
